...
#define DESC_G_4K       1
#define DESC_D_32       1
#define DESC_L          0 // we do not use 64-bit mode
#define DESC_AVL        0
#define DESC_P          1
#define DESC_DPL_0      0
#define DESC_DPL_1      1
...
#define DESC_S_SYS      0
#define DESC_TYPE_CODE  8 // 1000, x=1,c=0,r=0,a=0
...
#define SELECTOR_K_GS       ((3 << 3) + (TI_GDT << 2) + RPL0) // graphics
...
#define EFLAGS_IF_1     (1 << 9) // 1, open interrupt
#define EFLAGS_IF_0     0 // 0, close interrupt
#define EFLAGS_IOPL_3   (3 << 12) // To test user progrom io under non-system call.
